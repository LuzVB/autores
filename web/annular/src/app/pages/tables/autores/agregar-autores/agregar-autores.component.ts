...
export class AgregarAutoresComponent implements OnInit {
  ...
  formulario() {
    this.form = new FormGroup({
      ...
      'barrio': new FormControl('', [Validators.required, Validators.maxLength(35), Validators.minLength(5)]),
      'direccion': new FormControl('', [Validators.required, Validators.maxLength(35), Validators.minLength(5)])
    }
    );
  }
