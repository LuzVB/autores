...
export const verticalMenuItems = [ 
    ...
    new Menu (3, 'Autores', '/tables/autores', null, 'supervisor_account', null, false, 0), 
    new Menu (4, 'UI Features', null, null, 'computer', null, true, 0),   
    new Menu (5, 'Buttons', '/ui/buttons', null, 'keyboard', null, false, 3),  
    new Menu (6, 'Cards', '/ui/cards', null, 'card_membership', null, false, 3), 
    new Menu (7, 'Lists', '/ui/lists', null, 'list', null, false, 3), 
    new Menu (8, 'Grids', '/ui/grids', null, 'grid_on', null, false, 3), 
    new Menu (9, 'Tabs', '/ui/tabs', null, 'tab', null, false, 3), 
    new Menu (10, 'Expansion Panel', '/ui/expansion-panel', null, 'dns', null, false, 3),
    new Menu (11, 'Chips', '/ui/chips', null, 'label', null, false, 3),
    new Menu (12, 'Progress', '/ui/progress', null, 'data_usage', null, false, 3), 
    new Menu (13, 'Dialog', '/ui/dialog', null, 'open_in_new', null, false, 3), 
    new Menu (14, 'Tooltip', '/ui/tooltip', null, 'chat_bubble', null, false, 3), 
    new Menu (15, 'Snackbar', '/ui/snack-bar', null, 'sms', null, false, 3), 
    new Menu (16, 'Dynamic Menu', '/dynamic-menu', null, 'format_list_bulleted', null, false, 0),    
    new Menu (17, 'Mailbox', '/mailbox', null, 'email', null, false, 0),
    new Menu (18, 'Chat', '/chat', null, 'chat', null, false, 0),
