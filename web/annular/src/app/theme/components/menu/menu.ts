...
export const verticalMenuItems = [ 
    ...
    new Menu (3, 'Autores', '/tables/autores', null, 'group_add', null, false, 0), 
    new Menu (4, 'Lectores', '/tables/lectores', null, 'library_books', null, false, 0),
    new Menu (5, 'UI Features', null, null, 'computer', null, true, 0),   
    new Menu (6, 'Buttons', '/ui/buttons', null, 'keyboard', null, false, 3),  
    new Menu (7, 'Cards', '/ui/cards', null, 'card_membership', null, false, 3), 
    new Menu (8, 'Lists', '/ui/lists', null, 'list', null, false, 3), 
    new Menu (9, 'Grids', '/ui/grids', null, 'grid_on', null, false, 3), 
    new Menu (10, 'Tabs', '/ui/tabs', null, 'tab', null, false, 3), 
    new Menu (11, 'Expansion Panel', '/ui/expansion-panel', null, 'dns', null, false, 3),
    new Menu (12, 'Chips', '/ui/chips', null, 'label', null, false, 3),
    new Menu (13, 'Progress', '/ui/progress', null, 'data_usage', null, false, 3), 
    new Menu (14, 'Dialog', '/ui/dialog', null, 'open_in_new', null, false, 3), 
    new Menu (15, 'Tooltip', '/ui/tooltip', null, 'chat_bubble', null, false, 3), 
    new Menu (16, 'Snackbar', '/ui/snack-bar', null, 'sms', null, false, 3), 
