...
export const verticalMenuItems = [  
    new Menu (1, 'Autores', '/tables/autores', null, 'group_add', null, false, 0), 
    new Menu (2, 'Lectores', '/tables/lectores', null, 'visibility', null, false, 0),
    new Menu (3, 'Libros', '/tables/libros', null, 'library_books', null, false, 0)
]
